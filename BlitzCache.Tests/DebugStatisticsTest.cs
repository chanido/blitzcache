...
namespace BlitzCacheCore.Tests
{
    ...
    public class DebugStatisticsTest
    {
        ...
        public void Debug_EvictionCount()
        {
            ...
            Console.WriteLine($"Initial entry count: {initial.CurrentEntryCount}");
            ...
            Console.WriteLine($"After add entry count: {afterAdd.CurrentEntryCount}");
            
            // Remove the entry
            cache.Remove("test_key");
            var afterRemove = cache.Statistics;
            Console.WriteLine($"After remove eviction count: {afterRemove.EvictionCount}");
            Console.WriteLine($"After remove entry count: {afterRemove.CurrentEntryCount}");
